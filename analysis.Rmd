...
All maps show log(Observed/Expected) antibiotic use by Idaho county for 2019. Lighter colors represent more claims than expected after controlling for model covariates; darker colors represent fewer claims than expected. Gray indicates no data.
